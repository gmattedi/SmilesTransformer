...
1. Ran through ProcessLibrary.py with
     python ~/work/GENERAL/PythonTools/PythonTools/ProcessLibrary.py -i chembl_30_chemreps.csv -o chembl_30_chemreps_proc.smi -s SMILES -id name -o_sep ' ' --chunk_size 10000 --max_len 80
